taylor_atan MATLAB Python Package
...
2. Installing the taylor_atan Package

A. Change to the directory that contains the file setup.py and the subdirectory 
taylor_atan. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the taylor_atan Package

The taylor_atan package is on your Python path. To import it into a Python script or 
session, execute:
