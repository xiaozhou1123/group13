taylor_cos MATLAB Python Package
...
2. Installing the taylor_cos Package

A. Change to the directory that contains the file setup.py and the subdirectory 
taylor_cos. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the taylor_cos Package

The taylor_cos package is on your Python path. To import it into a Python script or 
session, execute:
