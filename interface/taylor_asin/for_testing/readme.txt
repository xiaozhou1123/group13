taylor_asin MATLAB Python Package
...
2. Installing the taylor_asin Package

A. Change to the directory that contains the file setup.py and the subdirectory 
taylor_asin. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the taylor_asin Package

The taylor_asin package is on your Python path. To import it into a Python script or 
session, execute:
